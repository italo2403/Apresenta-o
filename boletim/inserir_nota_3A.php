...
echo '</div>';
            ...
            echo '<div class="form-group">';
            echo '<label for="nota1_' . $row_aluno["aluno_id_3a"] . '">Menção AV1:</label>';
            echo '<input type="text" id="nota1_' . $row_aluno["aluno_id_3a"] . '" name="nota1[]" placeholder="Digite a nota da AV1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="nota2_' . $row_aluno["aluno_id_3a"] . '">Menção AV2:</label>';
            ...
            echo '</select>';
            echo '<label for="pos_noa_' . $row_aluno["aluno_id_3a"] . '">NOA:</label>';
            echo '<select id="pos_noa_' . $row_aluno["aluno_id_3a"] . '" name="pos_noa[]" >';
