    ...
    z-index: 1000; /* Para garantir que o botão esteja acima dos outros elementos */
}
...
@media (max-width: 768px) {
    ...
    echo '<option value="1">LITERATURA</option>';
    echo '<option value="2">PRODUÇÃO TEXTUAL</option>';
    echo '<option value="3">MATEMÁTICA</option>';
    echo '<option value="4">GEOGRAFIA</option>';
    echo '<option value="5">HISTÓRIA</option>';
    echo '<option value="6">INGLÊS</option>';
    echo '<option value="7">FORMAÇÃO PROFISSIONAL</option>';
    echo '<option value="8">PROJETO DE VIDA</option>';
    echo '<option value="9">PROGRAMAÊ</option>';
    echo '<option value="10">FILOSOFIA</option>';
    echo '<option value="11">QUÍMICA</option>';
    echo '<option value="12">ARTES</option>';
    echo '<option value="13">FÍSICA</option>';
    echo '<option value="14">BIOLOGIA</option>';
    echo '</select>';
    echo '</div>';
