...
SELECT d.nome AS disciplina, n.unidade, n.av1, n.av2, n.conceito, n.pos_noa, n.mencao_final_anual, n.total_faltas, n.mencao_final_pos_noa, n.resultado_final_anual
					FROM notas_1B n
					JOIN disciplinas d ON n.id_disciplina = d.id_disciplina
					WHERE n.aluno_id = aluno_id
					ORDER BY n.unidade;

SELECT d.nome AS disciplina, n.unidade, n.av1, n.av2, n.conceito, n.pos_noa,
