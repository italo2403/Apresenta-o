<!DOCTYPE html>
    ...
    echo '</div>';
                ...
                echo '<select id="unidade_' . $row_aluno["aluno_id_2a"] . '" name="unidade[]" required>';
                ...
                echo '<input type="text" id="nota1_' . $row_aluno["aluno_id_2a"] . '" name="nota1[]" placeholder="Digite a nota da AV1" required>';
                echo '</div>';
                echo '<div class="form-group">';
                echo '<label for="nota2_' . $row_aluno["aluno_id_2a"] . '">Menção AV2:</label>';
                echo '<input type="text" id="nota2_' . $row_aluno["aluno_id_2a"] . '" name="nota2[]" placeholder="Digite a nota da AV2" required>';
                echo '</div>';
                ...
                echo '<select id="conceito_' . $row_aluno["aluno_id_2a"] . '" name="conceito[]" required>';
                echo '<option value="A">D</option>';
                echo '<option value="B">ND</option>';
                echo '</select>';
                echo '<label for="pos_noa_' . $row_aluno["aluno_id_2a"] . '">NOA:</label>';
                echo '<select id="pos_noa_' . $row_aluno["aluno_id_2a"] . '" name="pos_noa[]" >';
