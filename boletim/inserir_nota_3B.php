...
echo '</div>';
            ...
            echo '<div class="form-group">';
            echo '<label for="unidade_' . $row_aluno["aluno_id_3b"] . '">Unidade:</label>';
            echo '<select id="unidade_' . $row_aluno["aluno_id_3b"] . '" name="unidade[]" required>';
            ...
            echo '<div class="form-group">';
            echo '<label for="nota1_' . $row_aluno["aluno_id_3b"] . '">Menção AV1:</label>';
            echo '<input type="text" id="nota1_' . $row_aluno["aluno_id_3b"] . '" name="nota1[]" placeholder="Digite a nota da AV1" required>';
            echo '</div>';
            echo '<div class="form-group">';
            echo '<label for="nota2_' . $row_aluno["aluno_id_3b"] . '">Menção AV2:</label>';
            echo '<input type="text" id="nota2_' . $row_aluno["aluno_id_3b"] . '" name="nota2[]" placeholder="Digite a nota da AV2" required>';
            echo '</div>';
            ...
            echo '<div class="form-group">';
            echo '<label for="conceito_' . $row_aluno["aluno_id_3b"] . '">Conceito:</label>';
            echo '<select id="conceito_' . $row_aluno["aluno_id_3b"] . '" name="conceito[]" required>';
            echo '<option value="A">D</option>';
            echo '<option value="B">NA</option>';
            echo '</select>';
            echo '<label for="pos_noa_' . $row_aluno["aluno_id_3b"] . '">NOA:</label>';
            echo '<select id="pos_noa_' . $row_aluno["aluno_id_3b"] . '" name="pos_noa[]" >';
