...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["id_aluno"]) && isset($_POST["unidade"]) && isset($_POST["nota1"]) && isset($_POST["nota2"]) && isset($_POST["conceito"]) 
    && isset($_POST["pos_noa"]) && isset($_POST["disciplina"]) && isset($_POST["mencao_final_anual"]) && isset($_POST["total_faltas"]) && isset($_POST["mencao_final_pos_noa"]) && isset($_POST["resultado_final_anual"])) {
        ...
        $sql_insert_notas = "INSERT INTO notas_1B (aluno_id, id_disciplina, unidade, av1, av2, conceito, pos_noa, mencao_final_anual, total_faltas, mencao_final_pos_noa, resultado_final_anual) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt) {
            ...
            $stmt->bind_param("iiissssssss", $id_aluno, $id_disciplina, $unidade, $nota1, $nota2, $conceito, $pos_noa, $mencao_final_anual, $total_faltas, $mencao_final_pos_noa, $resultado_final_anual);
